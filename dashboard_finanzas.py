...
st.set_page_config(page_title="Dashboard Finanzas - Noviembre 2025", layout="wide", initial_sidebar_state="expanded")

# Título principal
st.title("💰 Dashboard de Finanzas - Noviembre 2025")

# Cargar datos
@st.cache_data
def cargar_datos():
    excel_file = "CIERRE GASTOS ADMINISTRATIVOS NOVIEMBRE 2025.xlsx"
